...
export type Direction = "Top" | "Right" | "Bottom" | "Left" | "Horizontal" | "Vertical" | "Start" | "End" | "";
...
export type FontKeys = `${Color}` | `size${Size}` | `line${Size}` | `lato${Weight}`;
export type Fonts = {
    center: TextStyle;
    left: TextStyle;
    right: TextStyle;
...
export type Corners = "TopRight" | "BottomRight" | "BottomLeft" | "TopLeft" | "";
export type BorderKey = `${"rounded"}${Corners}${Size}` | `${Color}` | `width${Size}`;
export type Borders = {
